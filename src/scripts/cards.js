const cards = [
    ...
    },
    {
        ...
        keywords_up: [
            ...
            "repose",
            "serenity",
            "species of domestic harvest-home",
            "stability",
        ],
        keywords_rev: [
            "beauty",
    ...
    },
    {
        ...
        keywords_up: [
            ...
            "creative urge",
            "determination",
            "excessive degree in everything",
            "great force",
            "potential",
            "responsibility",
            "retribution",
...
const getCardObjectFromName = (cardName) => {
    const is_reversed = cardName.includes(" reversed"),
        card = cards.find(
            (card) => card.name === cardName.replace(" reversed", "")
        );
